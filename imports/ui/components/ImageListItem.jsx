...
function getStyles(props, context, state) {
  ...
  const styles = {
    ...
    innerDiv: {
      ...
      paddingLeft: leftIcon || leftAvatar || leftCheckbox || insetChildren ? 125 : 16,
...
class ImageListItem extends Component {
  ...
  static propTypes = {
     ...
     */
    /**
     * This is the block element that contains the info elements.
     * If a string is passed in, a div tag will be rendered.
     */
    info: PropTypes.node,
  ...
  render() {
    ...
    return (
      <div>
        ...
        {nestedList}
        {info ? <div style={{marginBottom: 5, fontFamily: 'Roboto, sans-serif'}}>{info}</div> : null}
      </div>
    );
  }
}
